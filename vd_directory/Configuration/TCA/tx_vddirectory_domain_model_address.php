...
return [
    'columns' => [
        ...
        'logo' => [
            ...
            'exclude' => true,
            'label' => 'LLL:EXT:vd_directory/Resources/Private/Language/locallang_tca.xlf:logo'
        ],
        'name' => [
            'config' => [
                'default' => '',
        ...
        'phones' => [
            'config' => [
                ...
                'foreign_table' => 'tx_vddirectory_domain_model_phone',
                'maxitems' => 3,
                'type' => 'inline'
            ],
            'exclude' => true,
            'label' => 'LLL:EXT:vd_directory/Resources/Private/Language/locallang_tca.xlf:phones'
        ],
        'sector' => [
            'config' => [
                'default' => 0,
            ...
            'label' => 'LLL:EXT:vd_directory/Resources/Private/Language/locallang_tca.xlf:sector'
        ],
        'service' => [
            'config' => [
                'default' => 0,
            ...
            'exclude' => true,
            'label' => 'LLL:EXT:vd_directory/Resources/Private/Language/locallang_tca.xlf:service'
        ],
        'theme' => [
            'config' => [
                'default' => 0,
            ...
            'label' => 'LLL:EXT:vd_directory/Resources/Private/Language/locallang_tca.xlf:theme'
        ],
        'www' => [
            'config' => [
                'default' => '',
    ...
    'ctrl' => [
        ...
        'groupName' => 'vd_directory',
        'label' => 'name',
        'searchFields' => 'address,bodytext,city,description,email,name,www,zip',
        'thumbnail' => 'logo',
        'title' => 'LLL:EXT:vd_directory/Resources/Private/Language/locallang_tca.xlf:addresses',
        'tstamp' => 'tstamp',
        'typeicon_classes' => [
    ...
    'palettes' => [
        'contact' => [
            'showitem' => 'email,--linebreak--,phones,--linebreak--,www'
        ],
        'location' => [
