...
return [
    'columns' => [
        ...
        'url' => [
            ...
            'label' => 'LLL:EXT:vd_pressreleases/Resources/Private/Language/locallang_db.xlf:url'
        ]
    ],
    'ctrl' => [
        'crdate' => 'crdate',
        ...
        'label' => 'title',
        'searchFields' => 'title',
        'title' => 'LLL:EXT:vd_pressreleases/Resources/Private/Language/locallang_db.xlf:links',
        'tstamp' => 'tstamp',
        'typeicon_classes' => [
            'default' => 'tx_vdpressreleases-link'
        ]
    ],
    'palettes' => [
        'access' => [
