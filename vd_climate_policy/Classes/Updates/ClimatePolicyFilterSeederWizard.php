...
class ClimatePolicyFilterSeederWizard implements UpgradeWizardInterface
{
    private const STORAGE_PID = 2025501;
    ...
    {
        return 'vdClimatePolicyFilterSeederWizard';
    }

    public function getTitle(): string
    {
        return 'VD Climate Policy: seed filter records';
    }
